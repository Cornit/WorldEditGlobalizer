package me.illgilp.worldeditglobalizer.server.bukkit.worldedit.adapter.v1_13_fawe_2_5_1;
...
import me.illgilp.worldeditglobalizer.server.bukkit.worldedit.adapter.v1_13_fawe_2_5_1.schematic.WegBlockArrayClipboard;
import me.illgilp.worldeditglobalizer.server.bukkit.worldedit.adapter.v1_13_fawe_2_5_1.schematic.WegClipboardHolder;
import me.illgilp.worldeditglobalizer.server.bukkit.worldedit.adapter.v1_13_fawe_2_5_1.schematic.WegMcEditSchematicReader;
import me.illgilp.worldeditglobalizer.server.bukkit.worldedit.adapter.v1_13_fawe_2_5_1.schematic.WegSpongeSchematicReader;
import me.illgilp.worldeditglobalizer.server.bukkit.worldedit.adapter.v1_13_fawe_2_5_1.schematic.WegSpongeSchematicWriter;
                        ...
                        .map(clipboard -> new WegClipboard() {
                            ...
                            public byte[] write() throws IOException {
                                try (final ByteArrayOutputStream out = new ByteArrayOutputStream();
                                     final com.sk89q.jnbt.NBTOutputStream nbtOut = new com.sk89q.jnbt.NBTOutputStream(out);
    ...
    public boolean readAndSetClipboard(WegPlayer player, byte[] data, int hashCode) {
        try {
            ...
            if (WegSpongeSchematicReader.isFormat(inputStream)) {
                ...
                WegSpongeSchematicReader reader = new WegSpongeSchematicReader(new com.sk89q.jnbt.NBTInputStream(inputStream));
            ...
            if (clipboard == null && WegMcEditSchematicReader.isFormat(inputStream)) {
                inputStream = new ByteArrayInputStream(data);
                session.setClipboard(null);
                WegMcEditSchematicReader reader = new WegMcEditSchematicReader(new com.sk89q.jnbt.NBTInputStream(inputStream));
                clipboard = reader.read();
            }
            if (clipboard == null) {
                MessageHelper.builder()
