...
import me.illgilp.intake.completion.CommandCompleter;
import me.illgilp.intake.completion.NullCompleter;
import me.illgilp.intake.dispatcher.Dispatcher;
import me.illgilp.intake.parametric.handler.ExceptionConverter;
import me.illgilp.intake.parametric.handler.InvokeHandler;
import me.illgilp.intake.parametric.handler.InvokeListener;
import me.illgilp.intake.util.auth.Authorizer;
import me.illgilp.intake.util.auth.NullAuthorizer;
...
public class ParametricBuilder {
    ...
    private me.illgilp.intake.parametric.CommandExecutor commandExecutor = new CommandExecutorWrapper(MoreExecutors.newDirectExecutorService());

    public ParametricBuilder(me.illgilp.intake.parametric.Injector injector) {
     ...
     */
    public me.illgilp.intake.parametric.CommandExecutor getCommandExecutor() {
    ...
    public CommandCallable build(Object object, Method method) throws ParametricException {
        return me.illgilp.intake.parametric.MethodCallable.create(this, object, method);
    }
