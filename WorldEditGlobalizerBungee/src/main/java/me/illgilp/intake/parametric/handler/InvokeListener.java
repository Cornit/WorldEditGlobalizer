...
public interface InvokeListener {
     ...
     *
     * <p>An example use of an {@link me.illgilp.intake.parametric.handler.InvokeHandler} would be to verify permissions
     * added by the {@link Require} annotation.</p>
     *
     * <p>For simple {@link me.illgilp.intake.parametric.handler.InvokeHandler}, an object can implement both this
     * interface and {@link me.illgilp.intake.parametric.handler.InvokeHandler}.</p>
     *
