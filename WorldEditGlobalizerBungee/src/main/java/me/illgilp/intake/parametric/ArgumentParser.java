...
import me.illgilp.intake.ImmutableParameter;
import me.illgilp.intake.OptionType;
import me.illgilp.intake.Parameter;
...
import me.illgilp.intake.parametric.annotation.Switch;
 ...
 * {@link me.illgilp.intake.parametric.Injector}.
 */
public final class ArgumentParser {
    ...
    public Object[] parseArguments(CommandArgs args) throws ArgumentException, ProvisionException {
        return parseArguments(args, false, Collections.emptySet());
    }
    ...
    public static class Builder {
        private final me.illgilp.intake.parametric.Injector injector;
        ...
        public void addParameter(Type type, List<? extends Annotation> annotations) throws IllegalParameterException {
            ...
            me.illgilp.intake.parametric.Key<?> key = me.illgilp.intake.parametric.Key.get(type, classifier != null ? classifier.annotationType() : null);
            me.illgilp.intake.parametric.Binding<?> binding = injector.getBinding(key);
            if (binding == null) {
    ...
    private static class ParameterEntry {
        ...
        private final me.illgilp.intake.parametric.Key<?> key;
        private final me.illgilp.intake.parametric.Binding<?> binding;
        private final List<Annotation> modifiers;

        ParameterEntry(Parameter parameter, me.illgilp.intake.parametric.Key<?> key, me.illgilp.intake.parametric.Binding<?> binding, List<Annotation> modifiers) {
