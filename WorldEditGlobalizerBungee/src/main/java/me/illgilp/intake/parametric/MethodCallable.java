...
import me.illgilp.intake.Description;
...
final class MethodCallable extends AbstractParametricCallable {
    ...
    private MethodCallable(ParametricBuilder builder, me.illgilp.intake.parametric.ArgumentParser parser, Object object, Method method, Description description, List<String> permissions) {
    ...
    static MethodCallable create(ParametricBuilder builder, Object object, Method method) throws IllegalParameterException {
        ...
        me.illgilp.intake.parametric.ArgumentParser.Builder parserBuilder = new me.illgilp.intake.parametric.ArgumentParser.Builder(builder.getInjector());
