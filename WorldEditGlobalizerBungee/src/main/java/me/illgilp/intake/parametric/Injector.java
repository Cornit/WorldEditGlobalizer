...
public interface Injector {
    ...
    <T> me.illgilp.intake.parametric.Binding<T> getBinding(me.illgilp.intake.parametric.Key<T> key);
    ...
    <T> Provider<T> getProvider(me.illgilp.intake.parametric.Key<T> key);
