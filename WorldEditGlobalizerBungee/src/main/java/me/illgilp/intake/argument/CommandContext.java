...
public class CommandContext {
    ...
    private final me.illgilp.intake.argument.Namespace namespace;
    ...
    public CommandContext(String args, Set<Character> valueFlags, boolean allowHangingFlag)
        ...
        this(args.split(" ", -1), valueFlags, allowHangingFlag, new me.illgilp.intake.argument.Namespace());
    }
     ...
     */
    public CommandContext(String[] args, Set<Character> expectedValueFlags, boolean allowHangingFlag, me.illgilp.intake.argument.Namespace namespace) throws CommandException {
        ...
        originalArgs = args;
        command = args[0];
        this.namespace = namespace != null ? namespace : new me.illgilp.intake.argument.Namespace();
    ...
    public me.illgilp.intake.argument.Namespace getNamespace() {
        return namespace;
    }
    ...
    public static class Builder {
        ...
        private me.illgilp.intake.argument.Namespace namespace = new me.illgilp.intake.argument.Namespace();
