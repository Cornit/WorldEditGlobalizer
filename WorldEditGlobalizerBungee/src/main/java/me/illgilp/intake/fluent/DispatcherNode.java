...
public class DispatcherNode {
    ...
    private final me.illgilp.intake.fluent.CommandGraph graph;
     ...
     */
    DispatcherNode(me.illgilp.intake.fluent.CommandGraph graph, DispatcherNode parent, SimpleDispatcher dispatcher) {
        this.graph = graph;
        this.parent = parent;
     ...
     * {@link ParametricBuilder} assigned on the root {@link me.illgilp.intake.fluent.CommandGraph}.
     *
