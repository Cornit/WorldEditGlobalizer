...
public class InternalInjector implements Injector {
    ...
    private final me.illgilp.intake.internal.parametric.BindingList bindings = new me.illgilp.intake.internal.parametric.BindingList();
    ...
    public void install(Module module) {
        ...
        module.configure(new me.illgilp.intake.internal.parametric.InternalBinder(bindings));
    }
