...
public class InvalidUsageException extends CommandException {
    ...
    private final me.illgilp.intake.CommandCallable command;
     ...
     */
    public InvalidUsageException(me.illgilp.intake.CommandCallable command, List<String> aliasStack) {
     ...
     * @param aliasStack the command text that was typed, including parent commands
     */
    public InvalidUsageException(String message, me.illgilp.intake.CommandCallable command, List<String> aliasStack) {
     ...
     */
    public InvalidUsageException(String message, me.illgilp.intake.CommandCallable command, List<String> aliasStack, boolean fullHelpSuggested) {
     ...
     */
    public InvalidUsageException(String message, me.illgilp.intake.CommandCallable command, List<String> aliasStack, boolean fullHelpSuggested, Throwable cause) {
        super(message, cause);
