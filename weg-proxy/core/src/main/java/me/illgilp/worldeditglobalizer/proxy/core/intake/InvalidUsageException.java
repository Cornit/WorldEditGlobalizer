...
public class InvalidUsageException extends CommandException {
     ...
     * @param aliasStack the command text that was typed, including parent commands
     */
    public InvalidUsageException(@Nullable MessageHelper.Builder message, CommandCallable command, List<String> aliasStack) {
     ...
     */
    public InvalidUsageException(@Nullable MessageHelper.Builder message, CommandCallable command, List<String> aliasStack, boolean fullHelpSuggested) {
     ...
     */
    public InvalidUsageException(@Nullable MessageHelper.Builder message, CommandCallable command, List<String> aliasStack, boolean fullHelpSuggested, @Nullable Throwable cause) {
        super(message, cause);
