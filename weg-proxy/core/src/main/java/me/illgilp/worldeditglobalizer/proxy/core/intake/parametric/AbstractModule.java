...
import static me.illgilp.worldeditglobalizer.proxy.core.intake.util.Preconditions.checkArgument;
 ...
 * add bindings.
 */
public abstract class AbstractModule implements me.illgilp.worldeditglobalizer.proxy.core.intake.parametric.Module {
