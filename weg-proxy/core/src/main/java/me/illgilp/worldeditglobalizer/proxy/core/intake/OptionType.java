...
public abstract class OptionType {
    ...
    private static final class BooleanFlag extends OptionType {
        ...
        public CommandArgs transform(CommandArgs arguments) {
            ...
            return Arguments.copyOf(Collections.singletonList(v), arguments.getFlags(), arguments.getNamespace());
        }
    }
    ...
    private static final class ValueFlag extends OptionType {
        ...
        public CommandArgs transform(CommandArgs arguments) {
            ...
            if (value == null) {
                return Arguments.copyOf(Collections.emptyList(), arguments.getFlags(), arguments.getNamespace());
            }
            return Arguments.copyOf(Collections.singletonList(value), arguments.getFlags(), arguments.getNamespace());
        }
    }
