 ...
 */
public class AuthorizationException extends Exception implements MessageBuilderHolder {
    ...
    public AuthorizationException(MessageHelper.Builder messageBuilder) {
        super(Optional.ofNullable(messageBuilder).map(MessageHelper.Builder::buildPlain).orElse(null));
        this.messageBuilder = messageBuilder;
    }

    public AuthorizationException(MessageHelper.Builder messageBuilder, Throwable cause) {
